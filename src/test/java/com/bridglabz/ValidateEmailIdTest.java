...
public class ValidateEmailIdTest {
    ...
    @Test
    public void givenEmailIds_WhenProper_ShouldReturnExpectedResult() throws UserValidationException {
        boolean result = userValidation.validateEmailId(emailId);
        Assert.assertEquals(this.expectedResult, userValidation.validateEmailId(emailId));
    }
